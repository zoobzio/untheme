 ...
 * theme. Both contexts are remapped: the softer, lower-contrast pairing of the
 * four official Carbon themes (a gray-10 light surface against a gray-90 dark
 * surface rather than pure white against gray-100).
 */
export default preset.define({
  id: "g10-g90",
  name: "Gray 10 / Gray 90",
  modifiers: {
    color: {
      light: {
        background: "{gray-10}",
