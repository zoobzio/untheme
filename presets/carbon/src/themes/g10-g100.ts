 ...
 * 100 dark theme. Dark context inherits the base (Gray 100); only the light
 * context is remapped onto Gray 10, whose layered surfaces alternate
 * white/gray-10 from a gray-10 background.
 */
export default preset.define({
  ...
  modifiers: {
    color: {
      ...
      // Dark context inherits the base (Gray 100)
    },
  },
});
